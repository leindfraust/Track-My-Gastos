    ...
    <ion-page>
        ...
        <ion-content>
            ...
            <div class="container is-fluid">
                <h1 class="title">
                    <ion-img :src="require('../../public/assets/clothing.svg')" alt="cart" id="logo"></ion-img>&nbsp;Clothing
                </h1>
            </div>
            <section class="container is-fluid">
                ...
                <div
                    class="has-text-right animate__animated animate__fadeInUp"
                    ...
                    <ul v-for="(activities, index) in groupedActivities" :key="index">
                        ...
                        >
                            ...
                            <li
                                ...
                                v-for="activity in activities.filter((x: any) => { return x.type === 'Clothing' })"
                                :key="activity.date"
                            >
...
export default defineComponent({
    ...
    async mounted() {
        ...
        if (this.userDetails !== null) {
            ...
            }).filter((x: any) => { return new Date(x.date).toDateString() === new Date().toDateString() && x.type === 'Clothing' }), "date")
        } else {
            this.userDetails = []
        }
    },
