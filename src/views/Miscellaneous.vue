        ...
        <ion-content>
            ...
            <section class="container is-fluid">
                ...
                <div class="columns is-mobile">
                    <div class="column">
                        <div class="field">
                            <ion-input class="input" placeholder=" Item/Service" v-model="item"></ion-input>
                        </div>
                    </div>
                    <div class="column">
                        <div class="field">
                    ...
                    <ul v-for="(activities, index) in groupedActivities" :key="index">
                        ...
                        >
                            ...
                            <li
                                ...
                                v-for="activity in activities.filter((x: any) => { return x.type === 'Miscellaneous' })"
                                :key="activity.date"
                            >
...
export default defineComponent({
    ...
    async mounted() {
        ...
        if (this.userDetails !== null) {
            ...
            }).filter((x: any) => { return new Date(x.date).toDateString() === new Date().toDateString() && x.type === 'Miscellaneous' }), "date")
        } else {
            this.userDetails = []
        }
    },
