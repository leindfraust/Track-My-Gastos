      ...
      <section class="section is-large" id="introSection">
        <div class="container">
          <div class="container box" :class="{ 'is-hidden': promptSubmitMoney }">
            <h3
              class="title is-4 has-text-centered animate__animated animate__fadeInDown"
            >Tired of seeing your wallet magically empty? Rest easy, you can now track your expenses automatically!</h3>
            <br />
            <p
              class="subtitle has-text-centered is-4 animate__animated animate__fadeInLeft"
          ...
          >
            <ion-img
              @click="nextpromptSubmitMoney"
              :class="{ 'animate__animated animate__fadeOut': nextClicked }"
              :src="require('../../public/assets/nextbutton.svg')"
              alt="next-button"
              id="next-button"
            ></ion-img>
          </div>
          <div
            class="container box has-text-centered animate__animated animate__fadeInUp"
            :class="{ 'is-hidden': !promptSubmitMoney }"
          >
            <ion-label
              class="label subtitle is-3"
    ...
    <ion-content v-else style="position: relative;">
      ...
      <section>
        <div class="container is-fluid">
          ...
          >Your wallet money is nonexistent.</h1>
          <h1
            class="title is-4 has-text-white"
            v-if="parseFloat(userMoney) <= 499 && parseFloat(userMoney) > 0"
          >You might want to rethink your spending decisions.</h1>
          <h1
            class="title is-4 has-text-white"
            v-if="parseFloat(userMoney) >= 500"
          >You are doing a good job. Keep it up!</h1>
          <div class="container box">
                ...
                <section>
                  ...
                  <div class="field">
                    ...
                    <ion-img
                      v-if="userInputMoney !== ''"
                      class="animate__animated animate__fadeInUp"
                      :src="require('../../public/assets/confirmbutton.svg')"
                      id="confirm-button"
                      alt="confirm"
                      @click="addUserMoney"
                    ></ion-img>
            ...
            <div class="container">
              <ion-img
                v-if="parseFloat(userMoney) >= 500"
                :src="require('../../public/assets/fullbar.svg')"
                class="bar"
                alt="fullbar"
              ></ion-img>
              <ion-img
                v-if="parseFloat(userMoney) <= 499 && parseFloat(userMoney) > 0"
                :src="require('../../public/assets/halfbar.svg')"
                class="bar"
                alt="halfbar"
              ></ion-img>
              <ion-img
                v-if="parseFloat(userMoney) == 0"
                :src="require('../../public/assets/lowbar.svg')"
                class="bar"
                alt="lowbar"
              ></ion-img>
            </div>
          ...
          <div class="columns is-mobile">
            <div class="column">
              <ion-img
                :src="require('../../public/assets/clothing.svg')"
                @click="clothingNav"
                class="navItems"
                alt="cart"
              ></ion-img>
            ...
            <div class="column">
              <ion-img
                :src="require('../../public/assets/food.svg')"
                @click="foodNav"
                class="navItems"
                alt="cart"
              ></ion-img>
          ...
          <div class="columns is-mobile">
            <div class="column">
              <ion-img
                :src="require('../../public/assets/essentials.svg')"
                class="navItems"
                alt="cart"
                @click="essentialsNav"
              ></ion-img>
            ...
            <div class="column">
              <ion-img
                :src="require('../../public/assets/miscellaneous.svg')"
                class="navItems"
                alt="cart"
                @click="miscellaneousNav"
              ></ion-img>
