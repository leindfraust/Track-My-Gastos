        ...
        <ion-content>
            ...
            <section class="container is-fluid">
                ...
                <div class="columns is-mobile">
                    <div class="column">
                        <div class="field">
                            <ion-input class="input" placeholder=" Item" v-model="foodName"></ion-input>
                        </div>
                    </div>
                    <div class="column">
                        <div class="field">
                ...
                <div class="container" v-if="activities !== null">
                    <h4 class="title is-4">Food transactions:</h4>
                    <ul
                        v-for="(activity, index) in activities.filter((x: any) => { return x.type === 'Food' })"
                        :key="index"
                    >
                        <li>
        ...
        async subtractMoney() {
            ...
            if (subtractMoney < 0) {
                ...
                await this.userDetails.push({
                    type: 'Food',
                    description: `Bought ${this.foodName} for`,
