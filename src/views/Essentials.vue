    ...
    <ion-page>
        ...
        <ion-content>
            ...
            <section class="container is-fluid">
                ...
                <p class="subtitle is-5">Log your essential transactions:</p>
                    ...
                    <ul v-for="(activities, index) in groupedActivities" :key="index">
                        ...
                        >
                            ...
                            <li
                                ...
                                v-for="activity in activities.filter((x: any) => { return x.type === 'Essentials' })"
                                :key="activity.date"
                            >
...
export default defineComponent({
    ...
    async mounted() {
        ...
        if (this.userDetails !== null) {
            ...
            }).filter((x: any) => { return new Date(x.date).toDateString() === new Date().toDateString() && x.type === 'Essentials' }), "date")
        } else {
            this.userDetails = []
        }
    },
